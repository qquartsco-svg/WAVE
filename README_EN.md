...
r = screen_gravitational_wave(GravWaveInput(m1_solar=36, m2_solar=29, distance_mpc=410))
print(f"Chirp mass: {r.chirp_mass_solar:.1f} M☉  Strain: {r.strain_amplitude:.2e}")
```
